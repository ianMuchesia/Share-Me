                  ...
                  <div className="flex flex-wrap justify-center">
                    <div className="w-full lg:w-9/12 px-4">
                      <p className="mb-4 text-lg leading-relaxed text-white">
                       To create an image click on create on the navbar then you will be routed to the create page and start prompting to have your own profile like {user.username}
                      </p>
